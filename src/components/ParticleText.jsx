...
import { getParticleEntryPosition } from '../lib/dashboard/particle-entry';
import { fitParticleTextFontSize } from '../lib/dashboard/particle-text-fit';
  ...
  useEffect(() => {
    ...
    const startGather = (fromScatter = true) => {
      ...
      particles.forEach(particle => {
        if (fromScatter) {
          const entry = getParticleEntryPosition({
    ...
    const sampleText = async () => {
      ...
      if (measuredWidth > maxTextWidth) {
        resolvedSize = fitParticleTextFontSize(
          resolvedSize,
          measuredWidth,
          maxTextWidth,
          minFontSize
      ...
      particles = selected.map((target, index) => {
        ...
        const entry = getParticleEntryPosition({
          ...
          targetY: target.y,
          width,
          scatter: reducedMotion ? 0 : scatter,
          seed,
          depth
        });
