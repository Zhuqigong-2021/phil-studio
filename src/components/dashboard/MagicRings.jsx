// Adapted from React Bits' MagicRings (https://reactbits.dev/animations/magic-rings) —
// a WebGL shader that draws concentric rings pulsing outward from center, on a loop.
