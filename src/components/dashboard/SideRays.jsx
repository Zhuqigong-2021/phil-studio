...
void main() {
  ...
  gl_FragColor = color;
      ...
      // The window "resize" event only fires when the browser viewport itself changes —
      // not when this container's own box changes size for other reasons (a CSS/layout
      // change, a parent flexing, etc). Without this, the canvas keeps rendering at
      // whatever resolution it had at mount, then gets CSS-stretched to the new box size,
      // which shows up as a hard rectangular seam where the stale render doesn't line up
      // with the actual (now different) container bounds.
